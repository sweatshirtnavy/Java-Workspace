...
public class MainFrame extends javax.swing.JFrame{
	...
	public MainFrame(){
		...
		JPanel resultPanel = new JPanel();//사용자에게 결과값 출력해주는 출력용 패널
		...
		//plusBtn클릭시 => 두개의 정수값을 가져온 후 덧셈연산 결과를 result텍스트 상자에 출력
		...
		//ActionListener : 인터페이스이기 때문에 곧바로 생성불가
		//여기서 생성하고 싶다면 "미완성된 메소드" 완성시키면서 생성 => 익명 클래스 방식
