...
public class F_Logical {
	 ...
	 * 
	 * AND 연산자 : 논리값 && 논리값
	 * 			   왼쪽, 오른쪽 논리값이 둘다 TRUE여야 최종결과가 TURE가 반한됨.
	 * 
	 * OR 연산자 : 논리값 || 논리값
	...
	public void method1() {
		...
		System.out.println("사용자가 입력한값이 양수이면서 짝수입니까? " + result);
	...
	public void method2() {
		 ...
		 * 			 두개의 조선 모두 true여야 결과값도 true
		 * 			 둘중 하나라도 false인 경우 결과값은 false
		 * 
		 */
	...
	public void method4() {
		 ...
		 * 실행할때 오류는 나지 않지만, result1의 값이 어처피 false인데 왜 작성한 구문인지 물어보는것.
		 * 
		 */
