...
public class B_InDecrease {
	...
	public void method2() {
		...
		//예측
		int num = 20;
		System.out.println("현재 num : "+num); // 출력시 : 20 , num :  
	...
	public void method3() {
	   ...
	   public void quiz() {
	      ...
	      int h = 2; // (--b) + (d--); // a:5 , b:9, c:16, d:2(1), e:5, f:4, g:11, h:2
	      
	      int i = (a++) + b / (--c / f) * (g-- - d) % (++e + h); // a:6(7) , b:9, c:15, d:2(1), e:5, f:4, g:10, h:2
	      // 6+9 / 3 * 10 % 8
	      // 연산자 우선순위가 동일하면 앞에껏 먼저 실행시킴.
	      // 6 + 3 * 10 % 8
	      // 6 + 30 % 8
	      // 6 + 6
	      // i = 12
