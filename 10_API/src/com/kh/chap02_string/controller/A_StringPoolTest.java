...
public class A_StringPoolTest {
	...
	public void method1() {
		...
		//String클래스의 equals메소드 경우 주소값 비교 아닌 문자열 비교 오버라이딩
		...
		//정말 주소값을 알고싶을때 사용하는 메서드 System.identityHashCode(참조변수(래퍼런스변수));
	...
	public void method3() {
		...
		/*
		 * 기존의 상수풀의 연결이 끊긴 문자열들은 가비지 콜렉터가 알아서 정리
		 * 불변이라고 해서 수정이 아예안되는게 아니라
		 * 기존의 그 자리(원래있던 주소값)에서 수정되는 개념 아님
		 * 매번 새로운 주소값 참조 
		 */
	}
