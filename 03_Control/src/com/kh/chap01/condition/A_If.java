...
public class A_If {
	 ...
	 * 단, 이 순차적인 흐름을 바꾸고자 한다면 제어문을 지용해서 직접 제어 가능.
	 * 
	 * 선택적으로 실행시키고자 할때 => 제어문 (if문, switch문)
	 * 반복적으로 실행시키고자 할때 => 반복문
	 * 그 외에는 => 분기문
	 * 
	 * 조건문
	 ...
	 * 보통의 조건식에는 비교연산자, 논리연산자를 주로 사욯암.
	 * 
	 * 조건문은 크게 if문(단톡, if~else, if ~else if, 중복if), switch문으로 나뉨
	 */
	//삼항 연산자를 조건문으로 바꿔보기
	...
	public void method3() {
		 ...
		 * if(조건식1) {
		 * 	.. 조건식1이 true일경우 실행시킬 코드 작성..
		 * } else if(조건식2) {
		 * 	.. 조건식2이 true일경우 실행시킬 코드 작성..
		 * } else if(조건식3) {
		 * 	.. 조건식3이 true일경우 실행시킬 코드 작성..
		 * } else {
	...
	public void method5() {
		Scanner sc = new Scanner(System.in);
		// 사용자에게 이름, 성별울 입력받아 남자인지, 여자인지 출력하는 메서드
	...
	public void method6() {
		...
		//사용자에게 이름을 입력받아 민경민과 일치하는지 비교해보기
	...
	public void method7() {
		...
		System.out.print("정수(양수)를 입력해주세요.");
		int num = sc.nextInt();
